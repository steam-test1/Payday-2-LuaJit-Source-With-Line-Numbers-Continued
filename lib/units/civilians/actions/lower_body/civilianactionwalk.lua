...
CivilianActionWalk._walk_anim_velocities = {stand = {
	ntl = {
		walk = {
			bwd = 111.3,
			l = 136.1,
...
CivilianActionWalk._anim_movement = {stand = {
	run_stop_l = 110,
	run_stop_fwd = 120,
	run_stop_r = 80,
	run_start_turn_bwd = {ds = Vector3(49, -161, 0)},
	run_start_turn_l = {ds = Vector3(-250, 90, 0)},
