...
CopActionAct._act_redirects.SO = {
	...
	"e_nl_up_1m_down_9m_swing",
	"e_nl_up_1m_down_8m_swing",
	"e_nl_up_1m_down_6m_swing",
	...
	"e_nl_jump_5m_long_0_6m_dwn",
	"e_nl_jump_5m_long_0_6m_up",
	"e_nl_up_3m",
	"e_nl_dwn_5_6m",
	"e_nl_up_0_7m",
	"e_nl_dwn_0_7m",
...
function CopActionAct:update(t)
	...
	if not self._ext_anim.act or vis_state == 1 then
		-- Nothing
