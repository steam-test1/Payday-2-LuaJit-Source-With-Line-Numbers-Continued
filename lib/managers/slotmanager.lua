...
function SlotManager:init()
	...
	self._masks.players_only_local = World:make_slot_mask(2, 4)
	self._masks.players_only_husks = World:make_slot_mask(3, 5)
	self._masks.criminals = World:make_slot_mask(2, 3, 16, 25)
	self._masks.civilians = World:make_slot_mask(21)
	self._masks.hostages = World:make_slot_mask(22)
