...
function MenuCallbackHandler:play_event_game()
	...
	managers.mutators:reset_all_mutators()
	mutator_manager:set_enabled(mutator_manager:get_mutator(MutatorPiggyRevenge), true)
	managers.features:announce_feature("pda10_event_explanation")
	managers.mission:set_saved_job_value("pda10_participation", true)
	managers.menu:active_menu().callback_handler:_update_mutators_info()

	local sidebar_exclude_filter = {
		"menu_cn_short",
		"menu_cn_chill",
		"menu_cn_casino",
		"menu_mutators",
	...
	table.insert(sidebar_exclude_filter, "menu_cn_leakedrecording_separator")
	table.insert(sidebar_exclude_filter, "menu_cn_leakedrecording")
	managers.crimenet:set_sidebar_exclude_filter(sidebar_exclude_filter)
end
