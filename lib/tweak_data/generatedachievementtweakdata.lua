...
function init_auto_generated_achievement_data(tags)
	return {
		...
		trk_af_0 = {
			...
			ladder = "H_After",
			sort_name = "C_Vlad_H_Aftershock_AllDiffs_D0",
			additional_id = true,
			tags = {
				tags.progress.completion,
				tags.difficulty.normal,
		...
		trk_af_1 = {
			...
			ladder = "H_After",
			sort_name = "C_Vlad_H_Aftershock_AllDiffs_D1",
			additional_id = true,
			tags = {
				tags.progress.completion,
				tags.difficulty.hard,
		...
		trk_af_2 = {
			...
			ladder = "H_After",
			sort_name = "C_Vlad_H_Aftershock_AllDiffs_D2",
			additional_id = true,
			tags = {
				tags.progress.completion,
				tags.difficulty.very_hard,
		...
		trk_af_3 = {
			...
			ladder = "H_After",
			sort_name = "C_Vlad_H_Aftershock_AllDiffs_D3",
			additional_id = true,
			tags = {
				tags.progress.completion,
				tags.difficulty.overkill,
		...
		trk_tt_0 = {
			icon_id = "C_Bain_H_TransportTrainHeist_AllDiffs_D0",
			ladder = "H_TransportTrainHeist",
			sort_name = "C_Bain_H_TransportTrainHeist_AllDiffs_D0",
			additional_id = true,
			tags = {
				tags.progress.completion,
				tags.difficulty.normal,
		...
		trk_tt_1 = {
			icon_id = "C_Bain_H_TransportTrainHeist_AllDiffs_D1",
			ladder = "H_TransportTrainHeist",
			sort_name = "C_Bain_H_TransportTrainHeist_AllDiffs_D1",
			additional_id = true,
			tags = {
				tags.progress.completion,
				tags.difficulty.hard,
		...
		trk_tt_2 = {
			icon_id = "C_Bain_H_TransportTrainHeist_AllDiffs_D2",
			ladder = "H_TransportTrainHeist",
			sort_name = "C_Bain_H_TransportTrainHeist_AllDiffs_D2",
			additional_id = true,
			tags = {
				tags.progress.completion,
				tags.difficulty.very_hard,
		...
		trk_tt_3 = {
			icon_id = "C_Bain_H_TransportTrainHeist_AllDiffs_D3",
			ladder = "H_TransportTrainHeist",
			sort_name = "C_Bain_H_TransportTrainHeist_AllDiffs_D3",
			additional_id = true,
			tags = {
				tags.progress.completion,
				tags.difficulty.overkill,
