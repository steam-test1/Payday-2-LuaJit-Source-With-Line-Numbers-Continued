...
function BlackMarketTweakData:_init_weapon_skins()
	...
	self.weapon_skins.p90_woodland = {
		...
		parts = {
			wpn_fps_smg_p90_body_boxy = {
				[Idstring("mat_boxy_body"):key()] = {
					pattern_tweak = Vector3(6.45361, 0, 1),
					pattern_pos = Vector3(-0.659039, -0.740976, 0),
				...
				[Idstring("mat_boxy_sight_and_straps"):key()] = {base_gradient = Idstring("units/payday2_cash/safes/sfs/base_gradient/base_sfs_003_df")}
			},
	...
	self.weapon_skins.judge_woodland = {
		...
		parts = {
			wpn_fps_pis_judge_body_standard = {[Idstring("mtr_frame"):key()] = {
			...
			wpn_fps_pis_judge_body_modern = {[Idstring("mat_judge_modern"):key()] = {
	...
	self.weapon_skins.judge_camohex = {
		...
		texture_bundle_folder = "cash/safes/cf15",
		reserve_quality = true,
		parts = {wpn_fps_pis_judge_body_modern = {[Idstring("mat_judge_modern"):key()] = {base_gradient = Idstring("units/payday2_cash/safes/grunt/base_gradient/base_grunt_007_df")}}}
	}
		...
		parts = {
			...
			wpn_fps_smg_p90_body_boxy = {
				[Idstring("mat_boxy_body"):key()] = {
					...
					sticker = Idstring("units/payday2_cash/safes/cf15/sticker/sticker_hoxton_hacks_df"),
					uv_scale = Vector3(3.31386, 3.36153, 1),
					uv_offset_rot = Vector3(-0.203673, 0.948013, 6.13334),
					pattern = Idstring("units/payday2_cash/safes/cf15/pattern/binary_pattern_df")
				},
				[Idstring("mat_boxy_sight_and_straps"):key()] = {
					base_gradient = Idstring("units/payday2_cash/safes/wwt/base_gradient/base_wwt_004_df"),
					pattern_tweak = Vector3(4.73647, 0, 1),
					pattern = Idstring("units/payday2_cash/safes/cf15/pattern/binary_pattern_df")
				}
			}
		},
	...
	self.weapon_skins.p90_skullimov = {
		...
		parts = {
			...
			wpn_fps_smg_p90_body_boxy = {
				[Idstring("mat_boxy_body"):key()] = {
					pattern_tweak = Vector3(0.491297, 2.53695, 1),
					sticker = Idstring("units/payday2_cash/safes/cop/sticker/sticker_overkill_df"),
					uv_scale = Vector3(2.16967, 2.21734, 0.303601),
					pattern_pos = Vector3(-1.51061, -1.68233, 0),
					uv_offset_rot = Vector3(-0.249292, 0.935473, 5.30916),
					pattern = Idstring("units/payday2_cash/safes/shared/pattern/pattern_acryl_001_df")
				},
				[Idstring("mat_boxy_sight_and_straps"):key()] = {
	...
	self.weapon_skins.judge_wooh = {
		...
		parts = {
			wpn_fps_pis_judge_g_standard = {
				...
				[Idstring("mat_judge_grip"):key()] = {base_gradient = Idstring("units/payday2_cash/safes/dallas/base_gradient/base_dallas_003_df")}
			},
			...
			wpn_fps_pis_judge_body_modern = {
				[Idstring("mat_judge_modern"):key()] = {
					pattern_tweak = Vector3(2.11305, 0, 0),
					sticker = Idstring("units/payday2_cash/safes/cop/sticker/sticker_bloodsplat_df"),
					uv_offset_rot = Vector3(0.330551, 0.902934, 0),
					uv_scale = Vector3(1.88362, 1.93129, 0),
					pattern_pos = Vector3(-0.033, 0.002, 0),
					base_gradient = Idstring("units/payday2_cash/safes/grunt/base_gradient/base_grunt_018_df"),
					pattern = Idstring("units/payday2_cash/safes/shared/pattern/pattern_checker_001_df")
				},
				[Idstring("mat_judge_barrel_modern"):key()] = {
					sticker = Idstring("units/payday2_cash/safes/cop/sticker/sticker_bloodsplat_df"),
					uv_offset_rot = Vector3(0.101598, 1.19866, 0)
				}
			}
		}
	}
	...
	self.weapon_skins.p90_golddigger = {
		...
		base_gradient = Idstring("units/payday2_cash/safes/cf15/base_gradient/base_cf15_004_df"),
		parts = {wpn_fps_smg_p90_body_boxy = {[Idstring("mat_boxy_sight_and_straps"):key()] = {base_gradient = Idstring("units/payday2_cash/safes/buck/base_gradient/base_buck_016_df")}}}
	}
	...
	self.weapon_skins.judge_bloodbath = {
		...
		parts = {
			...
			wpn_fps_pis_judge_body_modern = {
				[Idstring("mat_judge_modern"):key()] = {base_gradient = Idstring("units/payday2_cash/safes/wwt/base_gradient/base_wwt_010_df")},
				[Idstring("mat_judge_barrel_modern"):key()] = {
					pattern_gradient = Idstring("units/payday2_cash/safes/cop/pattern_gradient/gradient_cop_003_df"),
					pattern_pos = Vector3(-0.92869, -0.62342, 0),
					pattern_tweak = Vector3(0.682091, 2.41707, 1),
					pattern = Idstring("units/payday2_cash/safes/shared/pattern/pattern_hypnotic_001_df")
				}
			}
		}
		...
		parts = {
			wpn_fps_pis_judge_g_standard = {
				...
				[Idstring("mat_judge_grip"):key()] = {
					...
					pattern_tweak = Vector3(7.83687, 0, 0),
					pattern = Idstring("units/payday2_cash/safes/sputnik/pattern/pattern_stars_df")
				}
			},
			wpn_fps_pis_judge_body_standard = {
			...
			wpn_fps_pis_judge_body_modern = {
				...
				[Idstring("mat_judge_barrel_modern"):key()] = {
					pattern_tweak = Vector3(1.49297, 1.56991, 1),
	...
	self.weapon_skins.mac10_waves = {
		...
		parts = {
			...
			wpn_fps_smg_mac10_body_modern = {[Idstring("mtr_body_modern"):key()] = {
				pattern_tweak = Vector3(10.3172, 3.13635, 1),
				pattern_pos = Vector3(0.001, 0.0443599, 0)
			}}
		}
	}
	...
	self.weapon_skins.x_b92fs_ginger = {
		...
		parts = {
			...
			wpn_fps_pis_beretta_body_modern = {[Idstring("mtr_body_modern"):key()] = {pattern_tweak = Vector3(3.41591, 0, 1)}}
		},
		types = {
	...
	self.weapon_skins.mac10_wolf = {
		...
		pattern_tweak = Vector3(0, 0, 1),
		pattern_pos = Vector3(0, 0.00620103, 0),
		parts = {wpn_fps_smg_mac10_body_modern = {[Idstring("mtr_body_modern"):key()] = {
			pattern_tweak = Vector3(13.3739, 0, 1),
			pattern_pos = Vector3(-0.05, 0.290932, 0)
		}}},
		types = {
			lower_reciever = {
	...
	self.weapon_skins.judge_same = {
		...
		parts = {
			...
			wpn_fps_pis_judge_g_standard = {[Idstring("mat_judge_grip"):key()] = {base_gradient = Idstring("units/payday2_cash/safes/sfs/base_gradient/base_sfs_014_b_df")}},
			wpn_fps_pis_judge_body_modern = {
				[Idstring("mat_judge_modern"):key()] = {base_gradient = Idstring("units/payday2_cash/safes/grunt/base_gradient/base_grunt_004_df")},
				[Idstring("mtr_mech"):key()] = {
					pattern = "units/payday2_cash/safes/same/pattern/pattern_same_006_b_df",
					pattern_gradient = "units/payday2_cash/safes/same/pattern_gradient/pattern_gradient_same_006_df",
					base_gradient = "units/payday2_cash/safes/same/base_gradient/base_gradient_same_006_df"
				...
				[Idstring("mat_judge_barrel_modern"):key()] = {
					pattern = "units/payday2_cash/safes/same/pattern/pattern_same_006_b_df",
					pattern_gradient = "units/payday2_cash/safes/same/pattern_gradient/pattern_gradient_same_006_df",
					base_gradient = Idstring("units/payday2_cash/safes/lones/base_gradient/base_lones_003_c_df"),
					pattern_pos = Vector3(0.559504, -0.241831, 0),
					pattern_tweak = Vector3(1.68376, 2.59689, 1)
				}
			}
		},
		types = {
	...
	self.weapon_skins.p90_same = {
		...
		parts = {
			...
			wpn_fps_smg_p90_body_boxy = {
				[Idstring("mat_boxy_sight_and_straps"):key()] = {base_gradient = Idstring("units/payday2_cash/safes/grunt/base_gradient/base_grunt_001_df")},
				[Idstring("mat_boxy_body"):key()] = {
					sticker = "units/payday2_cash/safes/same/sticker/sticker_same_007_df",
					uv_offset_rot = Vector3(-0.241831, 0.934092, 0),
					uv_scale = Vector3(5.1255, 4.7441, 1)
				}
			}
		}
	}
	...
	self.weapon_skins.x_b92fs_grunt = {
		...
		parts = {
			...
			wpn_fps_pis_beretta_body_modern = {[Idstring("mtr_body_modern"):key()] = {
				base_gradient = Idstring("units/payday2_cash/safes/grunt/base_gradient/base_grunt_018_df"),
				uv_offset_rot = Vector3(0.177916, 0.744759, 4.69278),
				uv_scale = Vector3(9.0825, 15.0895, 1),
				pattern_pos = Vector3(0.001, 0, 0)
			}}
		},
		types = {
	...
	self.weapon_skins.judge_lones = {
		...
		parts = {
			...
			wpn_fps_pis_judge_g_standard = {
				...
				[Idstring("mat_judge_grip"):key()] = {
					uv_offset_rot = Vector3(0.089598, 0.740759, 0),
					sticker = Idstring("units/payday2_cash/safes/lones/sticker/lones_sticker_010_df"),
					uv_scale = Vector3(5.64992, 5.64992, 1)
				}
			},
			wpn_fps_pis_judge_body_modern = {
				[Idstring("mat_judge_barrel_modern"):key()] = {
					pattern_gradient = Idstring("units/payday2_cash/safes/lones/pattern_gradient/gradient_lones_001_df"),
					pattern_tweak = Vector3(0.72979, 1.55596, 1),
					pattern_pos = Vector3(-0.423086, 0.521345, 0),
					base_gradient = Idstring("units/payday2_cash/safes/shared/base_gradient/base_shared_006_df"),
					pattern = Idstring("units/payday2_cash/safes/lones/pattern/lones_pattern_001_df")
				},
				[Idstring("mat_judge_modern"):key()] = {base_gradient = Idstring("units/payday2_cash/safes/grunt/base_gradient/base_grunt_014_df")}
			}
		}
	}
	...
	self.weapon_skins.mac10_sfs = {
		...
		parts = {
			...
			wpn_fps_smg_mac10_body_modern = {[Idstring("mtr_body_modern"):key()] = {
				pattern_tweak = Vector3(3.07072, 0, 1),
				pattern_pos = Vector3(-1.00447, -0.195133, 0)
			}}
		},
		types = {
			lower_reciever = {
	...
	self.weapon_skins.judge_cs3 = {
		...
		parts = {
			wpn_fps_pis_judge_body_standard = {[Idstring("mtr_cylinder"):key()] = {
			...
			wpn_fps_pis_judge_body_modern = {
				[Idstring("mat_judge_modern"):key()] = {
					uv_offset_rot = Vector3(0.121217, 0.948092, 0),
					uv_scale = Vector3(9.03482, 9.03482, 0)
				},
				[Idstring("mat_judge_barrel_modern"):key()] = {
					sticker = "units/payday2_cash/safes/cs3/sticker/cs3_sticker_001_df",
					uv_offset_rot = Vector3(0.0263599, 0.72206, 1.56993),
					uv_scale = Vector3(0.469401, 0.548726, 0)
				}
			}
		},
		types = {lower_reciever = {
	...
	self.weapon_skins.p90_cs4 = {
		...
		parts = {
			...
			wpn_fps_smg_p90_body_boxy = {
				...
				[Idstring("mat_boxy_body"):key()] = {pattern_tweak = Vector3(5.16575, 0, 1)}
			}
		},
		types = {
			foregrip = {},
	...
	self.weapon_skins.mac10_cs4 = {
		...
		parts = {wpn_fps_smg_mac10_body_modern = {[Idstring("mtr_body_modern"):key()] = {
			...
			base_gradient = Idstring("units/payday2_cash/safes/buck/base_gradient/base_buck_007_df"),
			pattern_pos = Vector3(-0.197593, -0.320689, 0),
			pattern_tweak = Vector3(1.54067, 0, 1)
		}}},
		types = {
			barrel_ext = {
	...
	self.weapon_skins.mac10_skf = {
		...
		parts = {
			...
			wpn_fps_smg_mac10_body_modern = {[Idstring("mtr_body_modern"):key()] = {base_gradient = Idstring("units/payday2_cash/safes/sfs/base_gradient/base_sfs_001_b_df")}}
		},
		types = {
